...
| [azurerm_route.database](https://registry.terraform.io/providers/hashicorp/azurerm/4.11.0/docs/resources/route) | resource |
...
| [azurerm_subnet.database](https://registry.terraform.io/providers/hashicorp/azurerm/4.11.0/docs/resources/subnet) | resource |
...
| [azurerm_subnet_route_table_association.database](https://registry.terraform.io/providers/hashicorp/azurerm/4.11.0/docs/resources/subnet_route_table_association) | resource |
...
| <a name="input_database_subnet_cidr"></a> [database\_subnet\_cidr](#input\_database\_subnet\_cidr) | The CIDR of the database subnet. Required when database\_vnet\_cidr is set. | `string` | `null` | no |
| <a name="input_database_subnet_delegation"></a> [database\_subnet\_delegation](#input\_database\_subnet\_delegation) | Optional delegation configuration for the database subnet. | <pre>object({<br>    name = string<br>    service_delegation = object({<br>      name    = string<br>      actions = list(string)<br>    })<br>  })</pre> | `null` | no |
| <a name="input_database_vnet_cidr"></a> [database\_vnet\_cidr](#input\_database\_vnet\_cidr) | An optional database CIDR block to associate with the cluster's VNET. This can be used to expand the cluster's available IP address space without needing to create a new VNET and migrate resources. | `string` | `null` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_database_subnet_id"></a> [database\_subnet\_id](#output\_database\_subnet\_id) | n/a |
