...
The v2 version of this Terraform project moves the messaging node pool modules from the cluster module to the main project so that they're more obvious and can be managed more directly (if desired).
